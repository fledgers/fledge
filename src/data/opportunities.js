...
const opportunities = [
  {
    ...
    year_eligibility_type: "specific",
    year_min: 1,
    year_max: 2,
  },
  {
    ...
    icon: "⚡",
    deadline: "2026-07-10",
    deadlineLabel: "Deadline: Jul 10",
    eligible_majors: [],
    major_eligibility_type: "all",
    year_eligibility_type: "all",
    year_min: 1,
    year_max: 4,
  },
  {
    ...
    icon: "🔬",
    deadline: null,
    listing_expires_at: "2026-12-31T15:59:59.999Z",
    application_url: "https://example.com/nus-urop",
  ...
  },
  {
    ...
    deadline: null,
    listing_expires_at: "2026-12-31T15:59:59.999Z",
    application_url: "https://example.com/young-changemakers",
    deadlineLabel: "Rolling applications",
    eligible_majors: [],
    major_eligibility_type: "all",
    year_eligibility_type: "all",
  ...
  },
  {
    ...
    location: "💻 Online",
    yearTag: "👤 Check year eligibility",
    badge: "Free",
    icon: "🎤",
    deadline: "2026-07-20",
